...
def get_followers(session: Session, user_id: int, page: int):
    ...
    follower_info = session.query(
        ...
        outerjoin(Follow2, Follow1.following == Follow2.follower). \
